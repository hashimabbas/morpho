...
export default function ColdChainHero(): JSX.Element {
          ...
          <div className="text-center lg:text-left">
            <div className="opacity-100 transition-all duration-700 ease-in-out starting:translate-y-4 starting:opacity-0">
              ...
              <p className="mt-6 max-w-xl text-lg text-gray-800 lg:mx-0 dark:text-gray-300">
                Morhpo Supply Chain Technologies The first company in the Gulf and middle East specializing in smart solutions for managing cold supply chains,
                utilizing Iot and AI Technologies to ensure
